...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" only registered users you can log in.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            try
            {
                ...
                String u,p;
                u=this.jTextField1.getText();
                p=this.jPasswordField1.getText();
                rs=st.executeQuery("Select * From LOGIN where EMAILID='"+u+"' and PASSWORD='"+p+"'");
                String f1,f2;
                f1=f2="";
                while(rs.next())
                {
                ...
                if(f1!="")
                {
                    JOptionPane.showMessageDialog (this, "Welcome "+f1+" to Library Sysyem.");
                }
                else
                {
                    JOptionPane.showMessageDialog (this, "Username or Password are mismatched...");
                }
            }
            catch(Exception e)
            {
